 ...
 *
 */
public class SECForm10KExtractor extends BaseSECFormExtractor {

	private static final Logger LOGGER = LoggerFactory.getLogger(SECForm10KExtractor.class);
	...
	public static List<SECItemSection> extractForm10UsingDiv(String xhtml) {
		...
		try {
			...
			for(Element elem : mainBodyElements){
				titles.add(extractTitlesWithStdTitle(elem.children(), SECConstants.FORM_10K_FILE_NAME));
